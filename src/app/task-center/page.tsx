...
export default function TaskCenterPage() {
  ...
  if (!mounted || isLoading) {
    return (
      <div className="flex h-svh items-center justify-center bg-[#EF4444]">
  ...
  return (
    <div className="flex flex-col h-svh bg-transparent text-gray-900 overflow-hidden font-body">
      <header className="px-6 pt-12 pb-6 flex items-center justify-between shrink-0 relative">
        ...
        <div className="text-center"><h1 className={cn("text-xl font-black font-headline tracking-widest uppercase", darkRedText)}>Task Center</h1><p className="text-[9px] font-black text-primary uppercase tracking-[0.2em] mt-1">Daily Flow Rewards</p></div>
      ...
      <main className="flex-1 overflow-y-auto px-6 pb-20 space-y-8 scroll-smooth">
        <section className="bg-white/40 backdrop-blur-xl rounded-[3rem] p-8 border border-white/40 relative overflow-hidden shadow-2xl">
          <div className="flex justify-between items-start mb-8">
            <div className="space-y-2"><h2 className={cn("text-3xl font-black font-headline leading-tight", darkRedText)}>Daily Attendance</h2><p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Maintain your streak for massive bonuses</p></div>
