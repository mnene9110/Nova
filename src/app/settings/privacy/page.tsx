    ...
    <div className="flex flex-col min-h-svh bg-transparent text-gray-900">
      ...
      <main className="flex-1 px-8 pt-4 pb-20 space-y-10 overflow-y-auto">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm font-medium text-gray-600 leading-relaxed bg-white/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/40">
            All audio and video calls on Matchflow are end-to-end encrypted using Agora and TRTC technology. We do not record, store, or monitor your private calls. Chat messages are stored securely in Firestore to allow synchronization across devices, and you have the right to delete them at any time.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm font-medium text-gray-600 leading-relaxed bg-white/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/40">
            Payment processing is handled by third-party providers like Paystack. Matchflow does not store your credit card or mobile money PINs. We only retain transaction records (amount, date, package) to maintain your coin balance and provide customer support.
          </p>
        </section>
